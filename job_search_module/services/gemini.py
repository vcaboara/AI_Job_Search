...
from google.generativeai.types import Part, Schema, GenerateContentConfig # FIXED: Explicitly import Part, Schema, GenerateContentConfig
...
class GeminiService(AbstractAIService):
    ...
    def __init__(
        ...
        if api_key:
            generativeai_sdk.configure(api_key=api_key)
        self.model = generativeai_sdk.GenerativeModel(self.model_name)
